...
dat_notifications_less %>% 
  writeVector("03_intermediate/dat_notifications_polygons_1_6.gdb")
...
dat_vpd_mean = 
  dat_vpd %>% 
  mean(na.rm = TRUE) %>% 
  writeRaster("03_intermediate/dat_vpd_mean.tif", filetype = "GTiff", overwrite = TRUE)
...
dat_ndvi_mean = 
  dat_ndvi %>% 
  mean(na.rm = TRUE) %>% 
  writeRaster("03_intermediate/dat_ndvi_mean.tif", filetype = "GTiff", overwrite = TRUE)

dat_notifications_ndvi = 
  read_csv("03_intermediate/data_notifications_ndvi.csv")
  # dat_notifications_less %>% 
