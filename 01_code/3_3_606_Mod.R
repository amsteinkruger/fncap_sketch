...
mod_5 = 
  feols(log(MBF) ~ 
          log(Stumpage_Lag_1) + log(Stumpage_Lag_2) + log(Stumpage_Lag_3) + log(Stumpage_Lag_4) + log(Stumpage_Lag_5) + log(Stumpage_Lag_6) + log(Stumpage_Lag_7) + log(Stumpage_Lag_8) + 
          log(Lumber_Lag_1) + log(Lumber_Lag_2) + log(Lumber_Lag_3) + log(Lumber_Lag_4) + log(Lumber_Lag_5) + log(Lumber_Lag_6) + log(Lumber_Lag_7) + log(Lumber_Lag_8) + 
          Fire_15_Doughnut + Fire_30_Doughnut + Fire_Proportion + 
          log(VPD_Lag_1) + log(VPD_Lag_2) + log(VPD_Lag_3) + log(VPD_Lag_4) + log(VPD_Lag_5) + log(VPD_Lag_6) + log(VPD_Lag_7) + log(VPD_Lag_8) + 
          Rate_Lag_1 + Rate_Lag_2 + Rate_Lag_3 + Rate_Lag_4 + Rate_Lag_5 + Rate_Lag_6 + Rate_Lag_7 + Rate_Lag_8,
        cluster = ~ Landowner,
        data = dat)
